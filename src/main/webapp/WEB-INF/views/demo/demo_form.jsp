...
<body>
			...
			<div class="row">
				<div id="content" class="col-lg-12">
					...
					<div class="box border green">
						...
						<div class="box-body">
							<form id="inputForm" class="form-horizontal" action="${ctx}/demo/${action}" method="post">
								<input type="hidden" name="id" value="${demo.id}"/>
								
								<div class="form-group">
									<label class="col-sm-2 control-label">名称</label>
									<div class="col-sm-10">
										<input type="text" id="demo_title" name="name" value="${demo.name}" class="form-control" placeholder="任务名称"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea rows="3" cols="5" id="description" name="title" class="autosize countable form-control" data-limit="100">${demo.title}</textarea>
	...
	<script>
		jQuery(document).ready(function() {
			...
			App.setPage("demo_forms");  //设置当前启动的页面
