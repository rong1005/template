...
<c:set var="Interior" value="<%=ApplyCheckType.Interior %>" />
								...
								<div class="box border blue">
									...
									<div class="box-body">
										...
										<label class="radio" style="font-size: 16px;font-weight: normal;">
											<input type="radio" class="uniform" id="apply_checkType" name="checkType" <c:if test="${(empty apply.checkType and applyCheckType eq Interior) or apply.checkType eq applyCheckType}">checked="checked"</c:if> value="${applyCheckType}"> 
