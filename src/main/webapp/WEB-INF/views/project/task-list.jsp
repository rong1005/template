								...
								<div class="box-body">
									...
									<table  class="table table-striped table-bordered table-hover">
										...
										<c:forEach items="${tasks.content}" var="task">
											<tr>
												<td>${task.title}</td>
												<td><a href="${ctx}/task/update/${task.id}">修改</a> / <a href="${ctx}/task/delete/${task.id}" onclick="return confirm('是否删除该任务？')">删除</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="pull-left">
												<a class="btn btn-info" href="${ctx}/task/create">创建任务</a>
											</div>
										</div>
									</div>
								</div>
